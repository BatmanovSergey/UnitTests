...
//    Нужно исправить код так, чтобы метод не выбрасывал ошибку.
    ...
    public static int sum(int a, int b) {
        assert (long)a+(long)b < Integer.MAX_VALUE:"Ошибка значение вышло за придел int";
        // если утверждение assert не выполняется, то выходит сообщение об ошибке
        return a+b;
    }
